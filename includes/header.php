...
<head>
  ...
  <link rel="stylesheet"
      ...
      integrity="sha512-SnH5WK+bZxgPHs44uWIX+LLJAJ9/2PkfAmQdH7SaQm9FZC2RjG4lJNlW1MGG2vGZCqC2ZKZ9KpQd8wC4h8hZfg=="
...
<div class="topbar">
  ...
  <div><img src="assets/img/logo.jpg" alt="Logo" class="topbar-logo-mobile"></div> <!-- spacer; no logo here -->
</div>
...
<div class="layout">
  <nav class="sidebar" id="sidebar">
    <div class="logo-wrap">
      <img src="assets/img/logo.jpg" alt="Namavi Labs" style="height:36px">
    ...
    function nav_active($file) {
      global $currentPath;
      // allow both dashboard and dashboard.php forms
